...
Ugh, the ERA5 data are *big* and operations are *slow*. I'm not a GIS expert, so spent a while playing around with `raster::crop()`, `raster::aggregate()`, etc., with little success.
