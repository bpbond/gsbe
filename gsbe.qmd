...
dat_test_spei <- dat_test_spei[-yr1cols]

message("Testing Random Forest...")
rf_spei <- ranger(sqrt_Rs_annual ~ ., data = dat_test_spei, importance = "impurity")
print(rf_spei)
sort(importance(rf_spei))
...
- **SPEI impact on Random Forest model is...unclear. Performance doesn't change.**

- **SPEI _does_ have effects in the linear model: significant interactions with many variables, and model R2 jumps modestly.**
